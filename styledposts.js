...
save.addEventListener('click', e =>{
    let data = `<p>Blog Title: ${title.value} </p>
                <p>Blog Data: ${date.value} </p>
                <p>Blog Summary: ${summary.value} </p>
                <button id="edit"><i class="fa-solid fa-pencil"></i>Edit</button>
                <button id="delete"><i class="fa-sharp fa-solid fa-trash"></i>Delete</button>`;
